...
1. **تقرأ كشف إنجاز** وتستخرج اسم كل طالبة ورمز خطتها (`4 - 3` = المنهج الرابع، المستوى الثالث؛ و`تلاوة-1` = التلاوة، المستوى الأول).
...
<p align="center"><img src="docs/page.png" alt="صفحة الأداة" width="420"></p>

---

## التشغيل

يتطلب Python 3.12 أو أحدث. والاختبارات والنشر يجريان على 3.14.4، وهو المثبّت في `render.yaml`.
...
تفتح الصفحة في المتصفح تلقائيًّا. وعلى macOS يكفي الضغط المزدوج على ملف **خطط الطالبات** في جذر المشروع (امتداده `.command`).
...
- **الاختبارات الآلية** (`pytest`) تغطي قراءة الكشف والفهرسة والاكتشاف والتعبئة، لكنها لا تثبت أن كل خانة في مكانها الصحيح؛ ذلك ما زال يحتاج نظرًا إلى الصفحات المرسومة. وتفاصيل الإجراء في [`CLAUDE.md`](CLAUDE.md).
...
شيفرة المشروع مرخّصة بـ[رخصة MIT](LICENSE): يجوز استعمالها ونسخها وتعديلها وتوزيعها بشرط إبقاء إشعار حقوق النشر.
والرخصة تشمل الشيفرة وحدها — لا القوالب ولا الخط، فلكلٍّ منهما ترخيصه المذكور أعلاه.
